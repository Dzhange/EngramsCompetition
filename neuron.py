...
class neuron:
    def __init__(self, params):
        ...
        self.solutions = np.zeros(params.numEquations)  # Why does nrn.solutions still function as a comment?
        ...
        self.pair_spiketimes = np.zeros(
            params.numnrn)  # Pair spike times for outgoing connections. Note that this only holds the most recent pair spiketime for each conn.
